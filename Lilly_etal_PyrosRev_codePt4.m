...
% %% FIG. 1 - COPEPOD, JeDI, GBIF (combined) -> Pres/Abs
...
% 1.1. 'Pyrosoma spp.'
% 1.1.1. COPEPOD
plt_c_pspp= scatterm(cpd_pspp_cln.LATITUDE,cpd_pspp_cln.LONGITDE,psz,'o','filled','MarkerFaceColor',dispcolsf1(1,:),'MarkerEdgeColor',edgecolsf1(1,:));
% 1.1.2. JeDI
plt_j_pspp= scatterm(jdi_pspp_cln.Lat,jdi_pspp_cln.Lon,psz,'o','filled','MarkerFaceColor',dispcolsf1(2,:),'MarkerEdgeColor',edgecolsf1(2,:));
% 1.1.3. GBIF
...
% 1.2.1. JeDI
plt_j_patl = scatterm(jdi_patl_cln.Lat,jdi_patl_cln.Lon,psz,'o','filled','MarkerFaceColor',dispcolsf1(3,:),'MarkerEdgeColor',edgecolsf1(3,:));
% 1.2.2. GBIF 
...
% 2.2.1. JeDI
plt_j_tspi = scatterm(jdi_tspi_cln.Lat,jdi_tspi_cln.Lon,psz,'o','filled','MarkerFaceColor',dispcolsf1(8,:),'MarkerEdgeColor',edgecolsf1(8,:));
% 2.2.2. GBIF
...
% 2.3.1. JeDI
plt_j_taga = scatterm(jdi_taga_cln.Lat,jdi_taga_cln.Lon,psz,'o','filled','MarkerFaceColor',dispcolsf1(9,:),'MarkerEdgeColor',edgecolsf1(9,:));
% 2.3.2. GBIF
...
% 3.2.1. JeDI
plt_j_lver = scatterm(jdi_lver_cln.Lat,jdi_lver_cln.Lon,psz,'o','filled','MarkerFaceColor',dispcolsf1(11,:),'MarkerEdgeColor',edgecolsf1(11,:));
% 3.2.2. GBIF
